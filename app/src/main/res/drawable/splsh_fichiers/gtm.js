...
"resource": {
  ...
  "rules":[
    ...
    [["if",1,17],["add",18]],
    [["if",1,2],["unless",6],["add",19,21,25,43]],
    [["if",1],["unless",2,6],["add",20,26,29,32,36,37]],
    [["if",1],["unless",2,6,9],["add",22]],
    [["if",1,19],["add",27]],
    [["if",1,20],["add",33]],
    [["if",1,2,21],["add",34]],
    [["if",22],["add",38]],
    [["if",1],["unless",2,23,24,25,26],["add",40]]]
},
"runtime":[]
...
return null},yd=!1;if(H.querySelectorAll)try{var Bd=H.querySelectorAll(":root");Bd&&1==Bd.length&&Bd[0]==H.documentElement&&(yd=!0)}catch(a){}var vd=yd;var Pd={},L=null,Qd=Math.random();Pd.B="GTM-5W9QXH7";Pd.Sb="990";Pd.Mh="";var Rd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Sd={__paused:!0,__tg:!0},Td;for(Td in Rd)Rd.hasOwnProperty(Td)&&(Sd[Td]=!0);var Ud="www.googletagmanager.com/gtm.js";
var Vd=Ud,Wd=null,Xd=null,Yd="//www.googletagmanager.com/a?id="+Pd.B+"&cv=180",Zd={},$d={},ae=function(){var a=L.sequence||1;L.sequence=a+1;return a};
...
return!a}function Tk(){var a=Sk();try{sk(F["GTMDataLayer"],Pd.B)}catch(b){}return a}
var Vk=function(){var a=Nc("GTMDataLayer",[]),b=Nc("google_tag_manager",{});b=b["GTMDataLayer"]=b["GTMDataLayer"]||{};mh(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});hk(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<L.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new Mk(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);Nk.push.apply(Nk,e);if(300<
